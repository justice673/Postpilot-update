...
function SidebarProvider({
  ...
  // Read viewport at click time so we never toggle the desktop collapse
  // state while the desktop sidebar is CSS-hidden on small screens.
...
function Sidebar({
  ...
  // Always mount the mobile sheet so the trigger works even if `isMobile`
  // state briefly disagrees with the CSS breakpoint.
  const mobileSheet = (
